                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['air_line_id'];?>">
                                            ...
                                            <td class="center"><img src="images/<?php echo $row['air_line_image'];?>" height="25" width="70" alt="Air Line"></td>
                                            <td class="center"><a href="air_lines?id=<?php echo $row['air_line_id'];?>"><img height="16" width="16" src="../images/edit.png" alt="Edit"></a>&nbsp;&nbsp;&nbsp;<a id="<?php echo $row['air_line_id'];?>" class='clsDelete'><img data-target="#myModal" data-toggle="modal" src="../images/delete.png" height="16" width="16" alt="Delete"></a></td>
                                        </tr>
									<?php } ?>	
