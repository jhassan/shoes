                            ...
                            <div class="row">
                                <div class="col-lg-12">
						            ...
						            <input type="hidden" name="ID" id="ID" value="<?php echo $ID; ?>" />
										...
										TextField("Air Line Code", "air_line_code", $Code, "3","6","form-control required");
										?>
                                        <div class="clear"></div>
                                        ...
                                        <div class="form-group col-lg-4 m-t-10">
                                        	<?php if(!empty($ID)) ?>
                                            <img src="images/<?php echo $Image;?>" height="25" width="70" alt="Air Line">
                                        </div>
                                        <div class="clear"></div>
		 ...
		 $("#myForm").submit(function(evt){	 
		   ...
		   $.ajax({
			 ...
			 success: function (response) {
				 if(response == "upload")
				 {
					 window.location.href="/unique_travels/admin/view_air_lines"; 
					 return true;
				 }
				else
				{
